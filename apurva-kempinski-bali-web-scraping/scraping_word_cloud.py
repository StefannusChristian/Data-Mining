...
def convert_review_to_wordcloud(reviews: str, wordcloud_file_name: str):
    ...
    sw = list(STOPWORDS)
    stopwords = list(set(["a","overall","place","for","this","internet","icon","hotel","to","yourself","property","place","stay","the","you","should","at","least","once","it","the","very","much","and","one","of","were","really","walk","need","wait","team","think","spend","bit","building","hiccups","ou","deco","dua","peak","complex","decor","koral","every","towards","apurva","extremely","sure","nusa","disa","little","planet","lagoon","cant","go","take","aspect","halls","although","needs","seen","returned","kempinski","ive","penny","look","trip","besides","later","already","long","back","alone","return","staying","come","will","bali","everything","swimming","room","stayed","bed","truly","possibly","welcome","dark","making","improveed","real","thank","better","staff","island","whole","season","going","forward","pools","rooms","check","time","despite","hotels","highly","improve","definitely"
        ]))
